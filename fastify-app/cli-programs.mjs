...
export function loadCliPrograms() {
  const programs = {
    ...
    gws: { executable: process.env.GWS_BIN || "gws", env: ["GOOGLE_WORKSPACE_CLI_CONFIG_DIR", "GOOGLE_WORKSPACE_CLI_CREDENTIALS_FILE"], readOnlyArgs: [["--version"]], blockedArgs: [["auth", "export"]] },
